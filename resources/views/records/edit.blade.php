...
<div class="fade-enter fade-enter-active animate-slide-up">
	<div style="margin-bottom: 2rem;">
		<h1 class="text-gradient-hero" style="font-size: 2.5rem; margin-bottom: 0.5rem; font-weight: 800;">✏️ Edit Record</h1>
		<p style="color: var(--muted-foreground); font-size: 1.1rem;">Update rice yield record information</p>
	</div>
